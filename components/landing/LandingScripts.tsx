...
export function LandingScripts({ integrations }: LandingScriptsProps) {
  const gaId = integrations["google_analytics"];
  const gtmId = integrations["google_tag_manager"];
  const pixelId = integrations["meta_pixel"];
  const hotjarId = integrations["hotjar"];
  const clarityId = integrations["microsoft_clarity"];
